...
export class CurrenciesController {
  ...
  async create(@Body() CreateCurrencyDto: CreateCurrencyDto) {
    ...
    const createdCurrency = await this.currenciesService.create(
      CreateCurrencyDto
    );
  ...
  async update(
    @Param("id") id: string,
    @Body() updatCurrencyDto: UpdatCurrencyDto
  ) {
    const updatedUser = await this.currenciesService.update(id, updatCurrencyDto);
